...
from apps.sport.api_endpoint.Chempionship import ChempionshipListAPIView, ChempionshipCreateAPIView, \
    ChempionshipUpdateAPIView, ChempionshipDestroyAPIView, ChempionshipRetrieveAPIView
from apps.sport.api_endpoint.Match import MatchListAPIView, MatchCreateAPIView, MatchUpdateAPIView, MatchDestroyAPIVIew
from apps.sport.api_endpoint.Match.MatchRetrieve.views import MatchRetrieveAPIView
from apps.sport.api_endpoint.Rating import RatingListAPIView, RatingCreateAPIView, RatingUpdateAPIView, \
    RatingDestroyAPIView, RatingRetrieveAPIView
from apps.sport.api_endpoint.Sport import SportListAPIView, SportCreateAPIView, SportUpdateAPIView, SportDestroyAPIView, \
    SportRetrieveAPIView
from apps.sport.api_endpoint.Team import TeamListAPIView, TeamCreateAPIView, TeamUpdateAPIView, TeamDestroyAPIView, \
    TeamRetrieveAPIView
