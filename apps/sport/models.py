...
class Chempionship(models.Model):
    name = models.CharField(max_length=128)
    sport = models.ForeignKey(Sport, on_delete=models.CASCADE, related_name='chempionship')
...
class Match(models.Model):
    ...
    team_1 = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='matches_as_1')
    team_2 = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='matches_as_2')
    winner = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='matches_as_win')
